...
namespace game {
	...
	EnemyBulletGameObject::EnemyBulletGameObject(const glm::vec3& position, Geometry* geom, Shader* shader, GLuint texture)
	...
	bool RCC(glm::vec2 P, glm::vec2 d, glm::vec2 C, float r, float& t1, float& t2) {
	...
	int EnemyBulletGameObject::Collision(const std::vector<GameObject*>& obj) {
